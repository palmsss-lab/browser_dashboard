        ...
        (function() {
            ...
            function refreshPageInfo() {
                ...
                document.getElementById('hostnameDisplay').innerText = window.location.hostname;
                document.getElementById('currentPageTitleDisplay').innerText = document.title;
            }
            ...
            function setupTitleUpdater() {
                ...
                btn.addEventListener('click', function() {
                    ...
                    if (newTitle !== '') {
                        ...
                        setTimeout(() => {
                            btn.innerHTML = '<i class="fas fa-pen"></i> Update Title';
                        }, 1000);
                    } else {
            ...
            function setupNavControls() {
                ...
                document.getElementById('redirectExampleBtn').addEventListener('click', function() {
                ...
                document.getElementById('goForwardBtn').addEventListener('click', function() {
            ...
            function updateHistoryLength() {
                document.getElementById('historyLength').innerText = window.history.length;
            }
